...
- Table 3: EPF compliance criteria per layer (EPF-k tiered compliance)
- Section 7: Formal evaluation protocol defining EPF-k compliance tiers
- Section 8: Limitations and open problems
- Thermo-time scheduling: formally defined as a named concept in L4
- Generalization Efficiency (GE) metric: formally defined and operationalized in L2
- Behavioral diversity metric (D_behavioral) defined in L5
- Fitness function F(a, E) formalized for speciation gates
...
- Section 2 restructured: each framework now includes interaction with others, not just definition
- L2 "reversible blocks" clarified and cited (Gomez et al. RevNets)
- L4 thermo-time scheduling elevated from bullet to named subsection
- L5 diversity quotas operationalized as KL-divergence metric
- Section 6 safety rails expanded: self-referential validation problem named and engaged
